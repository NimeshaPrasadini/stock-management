...
class StockItemController extends Controller
{
    ...
    //getting ItemNos from Item model
    ...
    //getting Item Details from Item model
    ...
    //This function is for control the stocks for one item
    //one item can have only three types of stocks(good, damage, destroy)
    ...
    //This function is for update item quantity when add items to the stock
    ...
    //This function is for update stock-item quantity when add items to the stock
    ...
    //display all stocks and items details in table view
    ...
    //load all stock and item details to the edit page
    ...
    //update all stock and item details
    ...
    //filter the no of items reached ROL
    ...
    //fetching data to reports generation re-order items
    ...
    //sending re-order items data for pdf function
    ...
    //sending data to search re-order items pdf generation
    ...
    //sending data for stocks reports generating function
     ...
     * @param $to_date
     * @return string
     * stocks pdf reports generating function
     */
     ...
     * @param $item_no
     * @return mixed
     * passing item no for search stocks pdf reports generating function
     */
     ...
     * @param $item_no
     * @return string
     * pdf report generating function for searched stock items
     */
     ...
     * @param Request $request
     * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\View\View
     * creating charts function for stocks
     */
    ...
    //creating bar charts function for stocks
    ...
    //creating pie charts function for stocks
    ...
    //creating charts function for rolItems
    ...
    //creating bar charts function for rolItems
    ...
    //creating pie charts function for rolItems
