...
{
    //store function for items details
    ...
    //function for items details view in the table
    ...
    //edit function for items details
    ...
    //update function for items details
    ...
    public function destroy($id) {
       ...
       // if('stocks.st_quantity' > 0){
            $item->delete();
            return redirect()->route('item_registration')->with('Success', 'Data Deleted');
      //  } else {
            //session()->put('danger', 'Cannot Delete the item, Because it has stocks');
           // return redirect()->route('item_registration');
                //->withErrors('Cannot Delete the item, Because it has stocks');
       // }
    ...
    //fetching data for items reports generating function
