        ...
        <div class="col-md-10 offset-2 mt-6">
            ...
            <img class="card-img-top" src="images/factory.png" alt="Card image" style="width:150px; height:150px; margin-right:auto; margin-left:auto; ">
                <div class="card-body">
                  ...
                  <center>  <a href="/subStockMenu" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
        ...
        <div class="card-deck">
            <div class="card"  style="height:21rem; width: 15rem;">
                ...
                <center>  <h4 class="card-title">Transport Management</h4></center>
                    ...
                    <center>   <a href="/tmMenu" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
        ...
        <div class="card-deck">
          ...
          <!--Leaving-->
            ...
            <div class="card" style="height:21rem; width:15rem;">
                ...
                <div class="card-body">
                <center> <h4 class="card-title">Leave Applications</h4></center>

                    <center> <a href="/applyLeave" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
