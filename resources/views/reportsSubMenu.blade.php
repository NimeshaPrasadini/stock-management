...
<div class="container-sm pt-3">
    <div class="card-deck">
        <div class="card" style="width:400px;">
            ...
            <div class="card-body">
                <h4 class="card-title">Item Reports</h4>
                <p class="card-text">See all items reports</p>
                <a href="/itemsReportWhole" class="btn btn-primary">Enter</a>
            </div>
        </div>
        ...
        <div class="card" style="width:400px;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">See all stocks reports</p>
                <a href="/stocksReports" class="btn btn-primary">Enter</a>
            </div>
        </div>
        ...
        <div class="card" style="width:400px;">
            ...
            <div class="card-body">
                <h4 class="card-title">GRN Reports</h4>
                <p class="card-text">See all GRN reports</p>
                <a href="" class="btn btn-primary">Enter</a>
            </div>
        </div>
        <div class="card" style="width:400px;">
            <img class="card-img-top" src="images/notepad.png" alt="Card image" style="width:100%;">
            <div class="card-body">
                <h4 class="card-title">Goods Return Note Reports</h4>
                <p class="card-text">See all GRE reports</p>
                <a href="/goodsReturnReports" class="btn btn-primary">Enter</a>
            </div>
        </div>
        <div class="card" style="width:400px;">
            <img class="card-img-top" src="images/package.png" alt="Card image" style="width:100%;">
            <div class="card-body">
                <h4 class="card-title">ROL Reports</h4>
                <p class="card-text">See all ROL items reports</p>
                <a href="" class="btn btn-primary">Enter</a>
            </div>
        </div>
